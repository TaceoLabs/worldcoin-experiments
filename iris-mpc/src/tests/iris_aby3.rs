mod iris_mpc_test {
    use crate::{
        ...
        prelude::{Aby3, MpcTrait, PartyTestNetwork, Sharable, TestNetwork3p},
        ...
        <T as std::convert::TryFrom<usize>>::Error: std::fmt::Debug,
    {
        ...
        for n in net {
            let t = tokio::spawn(async move {
                mask_test_aby3_impl_inner::<T, ChaCha12Rng>(n, seed, iris_seed).await
            });
            tasks.push(t);
        }
        ...
        <T as std::convert::TryFrom<usize>>::Error: std::fmt::Debug,
    {
        ...
        for n in net {
            let t = tokio::spawn(async move {
                hwd_test_aby3_impl_inner::<T, ChaCha12Rng>(n, seed, iris_seed).await
            });
            tasks.push(t);
        }
        ...
        <T as std::convert::TryFrom<usize>>::Error: std::fmt::Debug,
    {
        ...
        let share = Aby3::<PartyTestNetwork>::share(distance, T::VerificationShare::default(), rng)
            [id]
            .to_owned();
        ...
        <T as std::convert::TryFrom<usize>>::Error: std::fmt::Debug,
    {
        ...
        for n in net {
            let t = tokio::spawn(async move {
                lt_test_aby3_impl_inner::<T, ChaCha12Rng>(n, seed, iris_seed).await
            });
            tasks.push(t);
        }
        ...
        <T as std::convert::TryFrom<usize>>::Error: std::fmt::Debug,
    {
        ...
        for n in net {
            let t = tokio::spawn(async move {
                cmp_iris_test_aby3_impl_inner::<T, ChaCha12Rng>(n, seed, iris_seed).await
            });
            tasks.push(t);
        }
        ...
        <T as std::convert::TryFrom<usize>>::Error: std::fmt::Debug,
    {
        ...
        for n in net {
            let t = tokio::spawn(async move {
                full_test_aby3_impl_inner::<T, ChaCha12Rng>(n, seed, iris_seed).await
            });
            tasks.push(t);
        }
