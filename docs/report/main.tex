...
\begin{table}[ht]
    \centering
    \caption{Runtime and communication (in data sent per party) comparison of different MPC protocols, averaged over 3 runs. All parties run on different machines in different cities (slowest network speed $477\,\text{Mbit}/s$, slowest latency $8\,ms$). Benchmarks for code size $|\texttt{iris}| = 12800$ bits and database of size $|\texttt{DB}| = 100\,000$ iris codes. Chunk Size refers to number of dot-products and MSB extraction operations batched per communication round.}
    ...
    \begin{tabular}{lrrcrr}
        ...
        \midrule
        Plain                        & 1                           & -                              & -                             & $0.134$                     & -                        \\
        ABY3                         & 1                           & 10240                          & \xmark                        & $$                          & $0.598$                  \\
        SPDZWise                     & 1                           & 10240                          & \cmark                        & $$                          & $4.643$                  \\
        \midrule
        ABY3                         & 32                          & 10240                          & \xmark                        & $$                          & $0.598$                  \\
        SPDZWise                     & 32                          & 10240                          & \cmark                        & $$                          & $4.643$                  \\
        \bottomrule
    \end{tabular}
\end{table}
