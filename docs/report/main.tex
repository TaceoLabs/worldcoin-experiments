...
All benchmarks where performed on machines with an \textit{AMD EPYC 7543} CPU (32 threads, 2795 MHz) and 64 GB RAM.
...
\todo[inline]{We do not benchmark rotations, mention somewhere}
\todo[inline]{SPDZWise no benchmarks with 1 000 000 since DB does not fit into 64 GB RAM}
