...
The goal of the project is to construct an efficient MPC protocol computing an iris code membership check in a MPC-shared databases. Concretely, three parties ..
