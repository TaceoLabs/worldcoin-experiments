...
We continue by varying the database size and give benchmarks for $1\,000\,000$ iris codes in \Cref{tab::bench_network_1m}. We want to note, that we do not give benchmarks for the SPDZWise protocol here since the database unfortunately does not fit into 64 GB of RAM.
