...
\begin{table}[ht]
    ...
    \begin{tabular}{lrrcrr}
        ...
        \midrule
        SPDZWise                     & 32                          & 10240                          & \cmark                        & $1.159$                     & $4.643$                  \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[ht]
    ...
    \begin{tabular}{lrrcrr}
        ...
        \midrule
        Plain                        & 1                           & -                              & -                             & $$                          & -                        \\
        ABY3                         & 1                           & 10240                          & \xmark                        & $$                          & $5.925$                  \\
        \midrule
        ABY3                         & 32                          & 10240                          & \xmark                        & $3.386$                     & $5.925$                  \\
        ABY3                         & 32                          & 100096                         & \xmark                        & $2.566$                     & $5.925$                  \\
        \bottomrule
    \end{tabular}
\end{table}
...
Currently, multithreading is only enabled for the computationally intensive parts of the protocol. Futher optimizations could be achieved by also allowing the communication of the protocol to be multithreaded. However,
